(function () {
    ...
    angular.module('app').controller(controllerId, ['common', 'datacontext', '$http', '$timeout', stock]);

    function stock(common, datacontext, $http, $timeout) {
        ...
        function activate() {
            ...
            common.activateController(promises, controllerId)
                .then(function () { log('Activated Stock View'); });
        }
